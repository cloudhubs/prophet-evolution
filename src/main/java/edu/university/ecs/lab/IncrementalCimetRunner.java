...
public class IncrementalCimetRunner {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            Iterable<RevCommit> commitsIterable = git.log().add(repo.resolve("refs/remotes/origin/" + branch)).call();
            ...
            for (int i = 0; i < commitsList.size(); i++) {
                ...
                if (!isDesiredCommit && commitsList.get(commitsList.size() - 1).getName().equals(compareCommit)) {
            ...
            for (int i = 1; i < commitsList.size(); i++) {
                ...
                if (i == 1) {
                    ...
                    String[] mergeArgs = {FullCimetUtils.pathToIR, FullCimetUtils.pathToDelta, configPath, branch, commitsList.get(i).getName()};
                    ...
                    // Run IR Merge Runner on IR and Merge
                    String[] mergeArgs = {FullCimetUtils.pathToNewIR, FullCimetUtils.pathToDelta, configPath, branch, commitsList.get(i).getName()};
                    IRMergeRunner.main(mergeArgs);
                }
