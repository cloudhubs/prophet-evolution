...
public class ReportRunner {
    ...
    private static Map<MsModel, List<Delta>> getChangeMap(MsSystem system, String deltaPath) throws IOException {
        ...
        for (Delta delta : deltas) {
            ...
            // Add delta to list for the given MsModel if the list exists already, otherwise create a new map entry
