...
public class CallChange {
  ...
  private static final String ACTION_MSG3 =
      "A RestCall was possibly Modified! Old link was Broken, New link was Formed!";

  private static final String IMPACT_MSG1 = "No Impact!";
  private static final String IMPACT_MSG2 =
      "Endpoint of New link does not exist! Floating RestCall detected!";
