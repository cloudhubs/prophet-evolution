...
//    Map<String, Microservice> oldSystemMap = IRParserUtils.parseIRSystem(Path.of("out/rest-extraction-output-[1712174345434].json").toAbsolutePath().toString()).getServiceMap();
//      Map<String, Microservice> newSystemMap = IRParserUtils.parseIRSystem(Path.of("out/rest-extraction-output-[1712174345434].json").toAbsolutePath().toString()).getServiceMap();
//
