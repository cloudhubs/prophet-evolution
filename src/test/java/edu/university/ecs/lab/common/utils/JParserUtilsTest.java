...
class JParserUtilsTest {
  ...
  //        // Random 5
  ////        assert controller.getMethodCalls().contains(new MethodCall("getLogger",
  // "LoggerFactory", null));
  //
  //        assert controller.getEndpoints() != null;
  //        assert controller.getEndpoints().size() == 16;
  //        assert controller.getEndpoints().contains(new Endpoint("/api/v1/orderservice/welcome",
  // "GetMapping", "GET", null, null));
  //
  //
  //
  //    }
  ...
  //        assertEquals("./src/main/java/order/service/OrderServiceImpl.java",
  // jClass.getClassPath());
  ...
  //        assert methods.contains(new Method("getTicketListByDateAndTripId",
  // "public","@RequestBody Seat seatRequest, @RequestHeader HttpHeaders headers",  "HttpEntity"));
  //        assert methods.contains(new Method("createNewOrder", "public","@RequestBody Order
  // createOrder, @RequestHeader HttpHeaders headers",  "HttpEntity"));
  //        assert methods.contains(new Method("addCreateNewOrder", "public","@RequestBody Order
  // order, @RequestHeader HttpHeaders headers",  "HttpEntity"));
  //        // ...
  //        assert methods.contains(new Method("findAllOrder", "public","@RequestHeader HttpHeaders
  // headers",  "HttpEntity"));
  //
  //
  //    }
  ...
  //        assert methods.contains(new Method("getServiceUrl", "private", "String serviceName",
  // "String"));
  //        assert methods.contains(new Method("getSoldTickets", "public", "Seat seatRequest,
  // HttpHeaders headers", "Response"));
  //        // ...
  //        assert methods.contains(new Method("updateOrder", "public", "Order order, HttpHeaders
  // headers", "Response"));
  //
  //    }
  //
  ...
  //        assert endpoints.contains(new Endpoint("/api/v1/orderservice/welcome", "GetMapping",
  // "GET", null, null));
  //        //todo add more
  //
  //
