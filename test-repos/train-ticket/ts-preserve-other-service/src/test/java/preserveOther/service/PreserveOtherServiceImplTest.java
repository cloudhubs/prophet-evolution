...
public class PreserveOtherServiceImplTest {
  ...
  @InjectMocks private PreserveOtherServiceImpl preserveOtherServiceImpl;
  ...
  public void testPreserve() {
    OrderTicketsInfo oti =
        OrderTicketsInfo.builder()
    ...
    travelResult.setPrices(
        new HashMap<String, String>() {
          {
            put("confortClass", "1.0");
          }
        });
  ...
  public void testDipatchSeat() {
    ...
    Seat seatRequest =
        new Seat(
            StringUtils.Date2String(new Date()),
            "G1234",
            "start_station",
            "dest_station",
            2,
    ...
    Mockito.when(
        ...
        .thenReturn(reTicket);
    Ticket result =
        preserveOtherServiceImpl.dipatchSeat(
            StringUtils.Date2String(new Date()),
            "G1234",
            "start_station",
            "dest_station",
