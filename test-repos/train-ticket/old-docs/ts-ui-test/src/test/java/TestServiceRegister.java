...
public class TestServiceRegister {
  ...
  public void testRegister(String username, String password) throws Exception {
    ...
    if ("".equals(statusSignUp)) System.out.println("Failed,Status of Sign Up btn is NULL!");
    else System.out.println("Sign Up btn status:" + statusSignUp);
  ...
  public void testRegisterLogin(String username, String password) throws Exception {
    ...
    else System.out.println("Failed to login!" + "Wrong login Id or password!");
