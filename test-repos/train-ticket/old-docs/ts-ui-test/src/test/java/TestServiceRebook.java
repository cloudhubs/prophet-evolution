...
public class TestServiceRebook {
  ...
  public void getOrders() throws Exception {
    ...
    WebElement elementOrdertypeGTCJ =
        driver.findElement(By.xpath("//*[@id='microservices']/div[4]/div[1]/h3/input[1]"));
    WebElement elementOrdertypePT =
        driver.findElement(By.xpath("//*[@id='microservices']/div[4]/div[1]/h3/input[2]"));
    ...
    List<WebElement> ordersList =
        driver.findElements(By.xpath("//table[@id='all_order_table']/tbody/tr"));
    ...
    } else System.out.println("Cant't get orders information1");
