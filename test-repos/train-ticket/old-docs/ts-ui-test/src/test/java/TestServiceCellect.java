...
public class TestServiceCellect {
  ...
  public void testTicketCollect() throws Exception {
    ...
    js.executeScript(
        "document.getElementById('single_collect_order_id').value='5ad7750b-a68b-49c0-a8c0-32776b067703'");
    ...
    if ("".equals(statusTicketCollect)) System.out.println("False,status security check is null!");
    else System.out.println("Ticket Collect status:" + statusTicketCollect);
