...
public class TestServicePayment {
  ...
  public void testPayment() throws Exception {
    ...
    if (!"".equals(statusPayment)) System.out.println("Status of payment: " + statusPayment);
    else System.out.println("False, status of  payment result is null!");
  ...
  public void testPaymentList() throws Exception {
    ...
    List<WebElement> paymentList =
        driver.findElements(By.xpath("//table[@id='query_payment_list_table']/tbody/tr"));
    if (paymentList.size() > 0)
      System.out.printf(
          "Success to Query PaymentList and Payment list size is %d.%n", paymentList.size());
    else System.out.println("Failed to Query PaymentList or Payment list size is 0");
