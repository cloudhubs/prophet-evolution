...
public class TestFlowTwoPay {
  ...
  public void testPayOrder() throws Exception {
    ...
    for (i = 0; i < myOrdersList.size(); i++) {
      ...
      // statusOrder =
      // myOrdersList.get(i).findElement(By.xpath("/div[2]/div/div/form/div[7]/div/label[2]")).getText();
      statusOrder =
          myOrdersList
              .get(i)
              .findElement(By.xpath("div[2]//form[@role='form']/div[7]/div/label[2]"))
              .getText();
      if (statusOrder.startsWith("Not")) break;
    }
    ...
    myOrdersList
        .get(i)
        .findElement(By.xpath("div[2]//form[@role='form']/div[7]/div/button"))
        .click();
    Thread.sleep(1000);
    String inputNotPaidOrderId =
        driver.findElement(By.id("pay_for_not_paid_orderId")).getAttribute("value");
    String inputNotPaidPrice =
        driver.findElement(By.id("pay_for_not_paid_price")).getAttribute("value");
    String inputNotPaidTripId =
        driver.findElement(By.id("pay_for_not_paid_tripId")).getAttribute("value");
    ...
    if (bNotPaidStatus == false) System.out.println("Step-Pay for Your Order,The input is null!!");
