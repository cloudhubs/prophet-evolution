...
class SleuthAdvisorConfig extends AbstractPointcutAdvisor
  ...
  private final class AnnotationClassOrMethodOrArgsPointcut extends DynamicMethodMatcherPointcut {
    ...
    public boolean equals(Object other) {
      ...
      AnnotationClassOrMethodOrArgsPointcut otherAdvisor =
          (AnnotationClassOrMethodOrArgsPointcut) other;
...
class SleuthInterceptor implements IntroductionInterceptor, BeanFactoryAware {
  ...
  public Object invoke(MethodInvocation invocation) throws Throwable {
    ...
    ContinueSpan continueSpan =
        SleuthAnnotationUtils.findAnnotation(mostSpecificMethod, ContinueSpan.class);
  ...
  private void logEvent(Item span, String name) {
    if (span == null) {
      logger.warn(
          "You were trying to continue a span which was null. Please "
