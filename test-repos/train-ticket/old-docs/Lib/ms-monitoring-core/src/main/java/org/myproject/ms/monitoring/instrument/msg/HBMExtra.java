...
public class HBMExtra implements MSTMExtra {
  ...
  private Item extractSpanFromHeaders(Map<String, String> carrier, Item.SpanBuilder spanBuilder) {
    ...
    if (Item.SPAN_SAMPLED.equals(flags)) {
      ...
      spanBuilder.exportable(Item.SPAN_SAMPLED.equals(carrier.get(TMHead.SAMPLED_NAME)));
    }
  ...
  private void setParentIdIfApplicable(
      Map<String, String> carrier, Item.SpanBuilder spanBuilder, String spanParentIdHeader) {
