...
public class TWAsp {
  ...
  private static final Log log = org.apache.commons.logging.LogFactory.getLog(TWAsp.class);
  ...
  @Pointcut(
      "(anyRestControllerAnnotated() || anyControllerAnnotated()) &&"
          + " anyPublicMethodReturningCallable()")
  ...
  @Pointcut(
      "execution(public *"
          ...
          + " args(request, response, handler, ex)")
  private void anyHandlerExceptionResolver(
  ...
  @Pointcut(
      "(anyRestControllerAnnotated() || anyControllerAnnotated()) &&"
          + " anyPublicMethodReturningWebAsyncTask()")
  ...
  public Object wrapWebAsyncTaskWithCorrelationId(ProceedingJoinPoint pjp) throws Throwable {
    ...
    if (this.tracer.isTracing()) {
      try {
        ...
        callableField.set(
            webAsyncTask,
            new SCTCall<>(this.tracer, this.traceKeys, this.spanNamer, webAsyncTask.getCallable()));
  ...
  public Object markRequestForSpanClosing(
