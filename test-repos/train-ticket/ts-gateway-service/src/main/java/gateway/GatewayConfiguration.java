 ...
 *
 * <p>主要是<a
 * href="https://sentinelguard.io/zh-cn/docs/api-gateway-flow-control.html">基于sentinel的网关限流策略配置</a>
 *
...
public class GatewayConfiguration {
   ...
   *
   * <p>默认是返回错误信息： “Blocked by Sentinel: FlowException”。 这里自定义了异常处理，封装了自然语句。
   */
   ...
   * 当前是简单的对转发到 admin-basic-info-service 服务的流量做了QPS限制，每秒不超过20个请求。
   */
  private void initGatewayRules() {
    ...
    // qps 超过 20 直接拒绝
    rules.add(
        new GatewayFlowRule("admin-basic-info") // 资源名称，对应路由 id
