...
public class CancelControllerTest {
  ...
  @InjectMocks private CancelController cancelController;
  ...
  public void testHome() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.get("/api/v1/cancelservice/welcome"))
  ...
  public void testCalculate() throws Exception {
    Mockito.when(cancelService.calculateRefund(Mockito.anyString(), Mockito.any(HttpHeaders.class)))
        .thenReturn(response);
    String result =
        mockMvc
            .perform(MockMvcRequestBuilders.get("/api/v1/cancelservice/cancel/refound/order_id"))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andReturn()
            .getResponse()
            .getContentAsString();
  ...
  public void testCancelTicket() throws Exception {
    ...
    String result =
        mockMvc
            .perform(MockMvcRequestBuilders.get("/api/v1/cancelservice/cancel/order_id/login_id"))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andReturn()
            .getResponse()
            .getContentAsString();
