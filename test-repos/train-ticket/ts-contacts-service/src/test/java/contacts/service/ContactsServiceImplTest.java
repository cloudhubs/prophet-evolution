...
public class ContactsServiceImplTest {
  ...
  @InjectMocks private ContactsServiceImpl contactsServiceImpl;
  ...
  public void testFindContactsById1() {
    ...
    Mockito.when(contactsRepository.findById(Mockito.any(UUID.class).toString()))
  ...
  public void testFindContactsByAccountId() {
    ...
    Mockito.when(contactsRepository.findByAccountId(Mockito.any(UUID.class).toString()))
        .thenReturn(arr);
  ...
  public void testCreate1() {
    Contacts addContacts =
        new Contacts(
            UUID.randomUUID().toString(), UUID.randomUUID().toString(), "name", 1, "12", "10001");
    ArrayList<Contacts> accountContacts = new ArrayList<>();
    accountContacts.add(addContacts);
    Mockito.when(contactsRepository.findByAccountId(Mockito.any(UUID.class).toString()))
        .thenReturn(accountContacts);
  ...
  public void testDelete1() {
    ...
    Mockito.doNothing()
        ...
        .deleteById(Mockito.any(UUID.class).toString());
    Mockito.when(contactsRepository.findById(Mockito.any(UUID.class).toString()))
        .thenReturn(Optional.empty());
