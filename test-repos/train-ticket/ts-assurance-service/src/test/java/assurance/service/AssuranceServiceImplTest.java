...
public class AssuranceServiceImplTest {
  ...
  @InjectMocks private AssuranceServiceImpl assuranceServiceImpl;
  ...
  public void testFindAssuranceById2() {
    ...
    Mockito.when(assuranceRepository.findById(id.toString()))
        .thenReturn(java.util.Optional.of(assurance));
    Response result = assuranceServiceImpl.findAssuranceById(id, headers);
    Assert.assertEquals(
        new Response<>(1, "Find Assurance Success", java.util.Optional.of(assurance)), result);
  }
  ...
  public void testDeleteById1() {
    ...
    Mockito.doNothing()
        ...
        .when(assuranceRepository)
        .deleteById(assuranceId.toString());
  ...
  public void testDeleteById2() {
    ...
    Mockito.doNothing()
        ...
        .deleteById(assuranceId.toString());
    Assurance assurance = new Assurance();
    Mockito.when(assuranceRepository.findById(assuranceId.toString()))
        .thenReturn(java.util.Optional.of(assurance));
    Response result = assuranceServiceImpl.deleteById(assuranceId, headers);
  ...
  public void testDeleteByOrderId1() {
    ...
    Mockito.doNothing()
        .doThrow(new RuntimeException())
        .when(assuranceRepository)
        .removeAssuranceByOrderId(orderId.toString());
    Mockito.when(assuranceRepository.findByOrderId(orderId.toString())).thenReturn(null);
  ...
  public void testModify2() {
    ...
    Assert.assertEquals(
        new Response<>(
            1, "Modify Success", new Assurance(null, null, AssuranceType.TRAFFIC_ACCIDENT)),
        result);
  }
  ...
  public void testGetAllAssuranceTypes() {
    ...
    AssuranceTypeBean assuranceTypeBean =
        new AssuranceTypeBean(1, "Traffic Accident Assurance", 3.0);
