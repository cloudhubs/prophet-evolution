...
public class VerifyCodeControllerTest {
  ...
  @InjectMocks private VerifyCodeController verifyCodeController;

  @Mock private VerifyCodeService verifyCodeService;
  ...
  public void testImageCode() throws Exception {
    ...
    map.put("image", image);
    Mockito.when(
            verifyCodeService.getImageCode(
                Mockito.anyInt(),
                Mockito.anyInt(),
    ...
    Mockito.verify(verifyCodeService, Mockito.times(1))
        .getImageCode(
            Mockito.anyInt(),
            Mockito.anyInt(),
            Mockito.any(OutputStream.class),
  ...
  public void testVerifyCode() throws Exception {
    ...
    String result =
        mockMvc
            .perform(MockMvcRequestBuilders.get("/api/v1/verifycode/verify/verifyCode"))
