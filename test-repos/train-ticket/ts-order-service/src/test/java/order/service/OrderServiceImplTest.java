...
public class OrderServiceImplTest {
  ...
  public void testCreate1() {
    ...
    Mockito.when(orderRepository.findByAccountId(Mockito.any(String.class)))
  ...
  public void testQueryOrdersForRefresh() {
    ...
    qi.setEnableTravelDateQuery(false);
    Response result =
        orderServiceImpl.queryOrdersForRefresh(qi, UUID.randomUUID().toString(), headers);
  ...
  public void testCheckSecurityAboutOrder() {
    ...
    Response result =
        orderServiceImpl.checkSecurityAboutOrder(new Date(), UUID.randomUUID().toString(), headers);
    Assert.assertEquals(
        new Response<>(1, "Check Security Success . ", new OrderSecurity(0, 0)), result);
  }
