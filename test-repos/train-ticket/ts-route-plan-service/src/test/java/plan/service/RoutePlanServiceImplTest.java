...
public class RoutePlanServiceImplTest {
  ...
  @InjectMocks private RoutePlanServiceImpl routePlanServiceImpl;
  ...
  public void testSearchCheapestResult() {
    ...
    ResponseEntity<Response<ArrayList<TripResponse>>> re1 =
  ...
  public void testSearchMinStopStations() {
    ...
    ResponseEntity<Response<ArrayList<ArrayList<Trip>>>> re3 =
        new ResponseEntity<>(response3, HttpStatus.OK);
    Mockito.when(
            restTemplate.exchange(
                Mockito.anyString(),
                Mockito.any(HttpMethod.class),
