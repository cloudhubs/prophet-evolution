...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity httpSecurity) throws Exception {
    httpSecurity
        ...
        .and()
        .authorizeRequests()
        .antMatchers("/api/v1/foodservice/**")
        .permitAll()
        .antMatchers(HttpMethod.DELETE, "/api/v1/foodservice/orders/*")
        .hasAnyRole(admin)
        .antMatchers(HttpMethod.PUT, "/api/v1/foodservice/orders")
        .hasAnyRole(admin)
        .antMatchers(HttpMethod.POST, "/api/v1/foodservice/orders")
        .hasAnyRole(admin)
        .antMatchers(
            "/swagger-ui.html",
            "/webjars/**",
