...
public class ConsignPriceServiceImpl implements ConsignPriceService {
  ...
  @Autowired private ConsignPriceConfigRepository repository;
  ...
  @Override
  public Response getPriceByWeightAndRegion(
      double weight, boolean isWithinRegion, HttpHeaders headers) {
