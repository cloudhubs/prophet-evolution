...
public class RouteServiceImplTest {
  ...
  @InjectMocks private RouteServiceImpl routeServiceImpl;
  ...
  public void testCreateAndModify1() {
    ...
    Assert.assertEquals(
        new Response<>(0, "Station Number Not Equal To Distance Number", null), result);
  }
  ...
  public void testDeleteRoute1() {
    Mockito.doNothing()
        ...
        .removeRouteById(Mockito.anyString());
    Mockito.when(routeRepository.findById(Mockito.anyString())).thenReturn(null);
  ...
  public void testDeleteRoute2() {
    ...
    Response result = routeServiceImpl.deleteRoute("route_id", headers);
    Assert.assertEquals(
        new Response<>(0, "Delete failed, Reason unKnown with this routeId", "route_id"), result);
  }
  ...
  public void testGetRouteByStartAndTerminal1() {
    ...
    distances.add(10);
    Route route =
        new Route(UUID.randomUUID().toString(), stations, distances, "shanghai", "nanjing");
