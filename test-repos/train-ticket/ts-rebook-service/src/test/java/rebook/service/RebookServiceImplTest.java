...
public class RebookServiceImplTest {
  ...
  @InjectMocks private RebookServiceImpl rebookServiceImpl;
  ...
  public void testPayDifference() {
    ...
    Assert.assertEquals(
        new Response<>(0, "Can't pay the difference,please try again", null), result);
  }
