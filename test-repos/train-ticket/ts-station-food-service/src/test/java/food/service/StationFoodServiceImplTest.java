...
public class StationFoodServiceImplTest {
  ...
  @InjectMocks private StationFoodServiceImpl foodMapServiceImpl;

  @Mock private StationFoodRepository stationFoodRepository;
  ...
  public void testListFoodStoresByStationName1() {
    ...
    Mockito.when(stationFoodRepository.findByStationName(Mockito.anyString()))
        .thenReturn(stationFoodStoreList);
  ...
  public void testGetFoodStoresByStationNames1() {
    ...
    List<StationFoodStore> stationFoodStoreList = new ArrayList<>();
    stationFoodStoreList.add(new StationFoodStore());
    Mockito.when(stationFoodRepository.findByStationNameIn(Mockito.anyList()))
        .thenReturn(stationFoodStoreList);
