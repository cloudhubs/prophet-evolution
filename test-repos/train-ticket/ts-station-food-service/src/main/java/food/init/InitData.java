...
public class InitData implements CommandLineRunner {
  ...
  @Autowired StationFoodService service;
  ...
  public void run(String... args) throws Exception {
    ...
    BufferedReader br1 =
        new BufferedReader(
            new InputStreamReader(this.getClass().getResourceAsStream("/foodstores.txt")));
    try {
    ...
    // InputStreamReader(this.getClass().getResourceAsStream("/trainfood.txt")));
    //        try{
