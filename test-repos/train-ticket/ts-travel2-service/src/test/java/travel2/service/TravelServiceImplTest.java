...
public class TravelServiceImplTest {
  ...
  @InjectMocks private TravelServiceImpl travel2ServiceImpl;
  ...
  public void testGetRouteByTripId1() {
    ...
    Assert.assertEquals(
        new Response<>(0, "\"[Get Route By Trip ID] Trip Not Found:\" + tripId", null), result);
  }
  ...
  public void testGetTrainTypeByTripId() {
    ...
    ResponseEntity<Response<edu.fudan.common.entity.TrainType>> re =
  ...
  public void testRetrieve1() {
    ...
    Assert.assertEquals(
        new Response<>(1, "Search Trip Success by Trip Id trip_id_1", trip), result);
  }
  ...
  public void testDelete1() {
    ...
    Mockito.doNothing()
        ...
        .when(repository)
        .deleteByTripId(Mockito.any(TripId.class));
